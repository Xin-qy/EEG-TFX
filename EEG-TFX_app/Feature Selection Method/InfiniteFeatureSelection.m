function [RANKED, WEIGHT] = InfiniteFeatureSelection(X, Y,varargin )
alpha=0.5;
supervision=1;
verbose=0;
[RANKED, WEIGHT] = infiniteFeatureSelection( X, Y, alpha, supervision, verbose );
end

function [RANKED, WEIGHT] = infiniteFeatureSelection( X_train, Y_train, alpha, supervision, verbose )
