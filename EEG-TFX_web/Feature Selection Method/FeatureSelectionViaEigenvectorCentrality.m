function [ rank , w] = FeatureSelectionViaEigenvectorCentrality( X,Y,varargin )

 numF=size(X,2);
[ rank , w] = featureSelectionViaEigenvectorCentrality( X,Y,numF );
end


function [ rank , w] = featureSelectionViaEigenvectorCentrality( X,Y,numF )
